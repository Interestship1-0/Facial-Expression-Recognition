...
train_d1 = create_training_data("D:\Aanshi\AANSHI2020\clique\data\Training")
train_d2 = create_training_data("D:\Aanshi\AANSHI2020\clique\data\img_augmented\Training")

print(len(train_d1))
print(len(train_d2))

np_train1 = np.array(train_d1)
np_train2 = np.array(train_d2)

np_train1 = np.expand_dims(np_train1, -1)
np_train2 = np.expand_dims(np_train2, -1)

#print(np_train[0])

#print(len(training_data))

#train_ds,validate_ds = np.split(np_train, [int(.8 * len(np_train))])

#print(len(train_ds))
#print(len(validate_ds))

#train_ds = train_ds.prefetch(buffer_size=32)
#validate_ds = validate_ds.prefetch(buffer_size=32)

#np_train = np.asarray(training_data)
...
train_ds,val_ds = split_data(np_train1,np_train2,0.2 )
